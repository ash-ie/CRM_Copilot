...
from accounts.serializers import MembershipSerializer, OrganizationSerializer, UserSerializer
...
class UserListCreateView(generics.ListCreateAPIView):
    queryset = User.objects.filter(is_deleted=False).order_by("email")
